		...
		<div class="row column">
			...
			<div class='player-wrapper'>
				<div class='foundation-player no-1'>
					...
					<audio id="audio1" src="audio/Blip_Stream.mp3" autoplay loop>
						Your browser doesn't support this audio thingy. Get another one if you want to hear noises.
					</audio>
				</div>
				<p><a href="https://incompetech.com/wordpress/2015/08/blip-stream/">'BLIP STREAM'</a> BY <a href="http://incompetech.com/">KEVIN MACLEOD</a> IS PLAYING SONG! <a href="credits.php#update_news_license">SEE LICENSE</a>.</p>
			</div>
		</div>
		<!-- End Audio Player -->
