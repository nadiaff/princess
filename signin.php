		...
		<div class="row column">
			...
			<div class='player-wrapper'>
				<div class='foundation-player no-1'>
					...
					<audio id="audio1" src="audio/Itty_Bitty_8_Bit.mp3" autoplay loop>
						Your browser doesn't support this audio thingy. Get another one if you want to hear noises.
					</audio>
				</div>
				<p><a href="http://incompetech.com/music/royalty-free/?keywords=bitty">'ITTY BITTY 8 BIT'</a> BY <a href="http://incompetech.com/">KEVIN MACLEOD</a> IS PLAYING SONG! <a href="credits.php#login_register_license">SEE LICENSE</a>.</p>
			</div>
		</div>
		<!-- End Audio Player -->
